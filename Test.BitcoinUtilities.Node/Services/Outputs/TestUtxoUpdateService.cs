    ...
    public class TestUtxoUpdateService
    {
        ...
        public void Test()
        {
            ...
            using (EventServiceController controller = new EventServiceController())
            {
                ...
                {
                    "PrefetchBlocksEvent: HeaderHashes[5]",
                ...
                Assert.AreEqual(new string[]
                {
                    "PrefetchBlocksEvent: HeaderHashes[4]",
                ...
                Assert.AreEqual(new string[]
                {
                    "PrefetchBlocksEvent: HeaderHashes[3]",
        ...
        private class EventLoggingService : EventHandlingService
        {
            ...
            {
                On<PrefetchBlocksEvent>(e => log.Log($"PrefetchBlocksEvent: HeaderHashes[{e.HeaderHashes.Count}]"));
