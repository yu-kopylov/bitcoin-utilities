...
namespace Test.BitcoinUtilities.Node
{
    ...
    public class TestNodeAddressCollection
    {
        ...
        public void TestUnknownAddress()
        {
            ...
            addressCollection.AddAddress(address1);
        ...
        public void TestUntestedTransitions()
        {
            ...
            addressCollection.AddAddress(address0);
            addressCollection.AddAddress(address1);
            addressCollection.AddAddress(address2);
            addressCollection.AddAddress(address3);
            addressCollection.AddAddress(address4);
