...
namespace Test.BitcoinUtilities
{
    ...
    public class TestBitcoinAddress
    {
        ...
        {
            Assert.That(BitcoinAddress.FromPublicKey(null, BitcoinNetworkKind.Main), Is.Null);
            Assert.That(BitcoinAddress.FromPublicKey(new byte[0], BitcoinNetworkKind.Main), Is.EqualTo("1HT7xU2Ngenf7D4yocz2SAcnNLW7rK8d4E"));
            ...
            Assert.That(BitcoinAddress.FromPublicKey(block1OutPubKey, BitcoinNetworkKind.Main), Is.EqualTo("12c6DSiU4Rq3P4ZxziKxzrL5LmMBrzjrJX"));
        }
        ...
        public void TestFromPublicKeyForTestnet()
        {
            ...
            {
                02,
                0x15, 0xC1, 0xA6, 0xF4, 0x9B, 0x05, 0x18, 0x94, 0x2F, 0x2B, 0xB8, 0x9D, 0x56, 0xAE, 0x83, 0x00,
                0x6E, 0x7D, 0xAB, 0x50, 0x7C, 0x35, 0x3F, 0x1F, 0x48, 0x31, 0x83, 0xBE, 0xF9, 0xA5, 0x36, 0xA1
            };
            Assert.That(BitcoinAddress.FromPublicKey(pubkey, BitcoinNetworkKind.Test), Is.EqualTo("mptxsPvryjbQ8Roa3QEWKJNpCWk3Jf35G7"));
        }
